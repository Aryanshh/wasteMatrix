      ...
      <div className="bg-white border-[6px] border-charcoal rounded-[3.5rem] p-12 w-full max-w-4xl shadow-[30px_30px_0px_var(--charcoal)] relative z-10 animate-fade-in grid grid-cols-1 md:grid-cols-2 gap-16">
        ...
        <div className="flex flex-col justify-between border-b md:border-b-0 md:border-r border-charcoal/10 pb-12 md:pb-0 md:pr-16">
          ...
          <div className="mt-12 space-y-4">
            {/* Proper Google Format - Locked Size */}
            <button 
              onClick={() => handleSocialAction('google')}
              disabled={!!socialLoading}
              className="w-full h-16 flex items-center justify-center gap-4 border-[3px] border-charcoal rounded-2xl font-bold text-[11px] uppercase tracking-widest hover:bg-slate-50 transition-all active:translate-y-1 bg-white shadow-[6px_6px_0px_var(--charcoal)] disabled:opacity-50"
            >
            ...
            {/* Proper Microsoft Format - Locked Size */}
            <button 
