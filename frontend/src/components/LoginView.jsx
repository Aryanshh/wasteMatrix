...
const LoginView = ({ onAuth }) => {
  ...
  return (
    <div className="min-h-screen bg-white flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="bg-white border-[6px] border-charcoal rounded-[3.5rem] p-12 w-full max-w-4xl shadow-[30px_30px_0px_var(--charcoal)] relative z-10 animate-fade-in grid grid-cols-1 md:grid-cols-2 gap-16">
        ...
        <div className="flex flex-col justify-between border-b md:border-b-0 md:border-r border-charcoal/10 pb-12 md:pb-0 md:pr-16">
          <div>
            ...
            <h2 className="font-['Anton'] text-7xl uppercase mb-6 leading-none">
              INDUSTRIAL <br/>NEXUS
            </h2>
            <p className="text-[10px] font-black text-charcoal/40 uppercase tracking-[0.4em] leading-relaxed max-w-xs">
          ...
          <div className="mt-12 space-y-4">
            ...
            >
              ...
              {socialLoading === 'microsoft' ? 'Linking Microsoft...' : 'Sign in with Microsoft'}
            </button>
          </div>
        </div>
          ...
          <div className="space-y-8 mb-12">
            {mode === 'signup' && (
              <div className="space-y-3">
                ...
                <input type="text" placeholder="Nordic Steel Works" className="input-brutal w-full text-sm border-[3px] rounded-xl focus:shadow-[4px_4px_0px_var(--primary)] transition-all duration-300" />
              </div>
            )}
            <div className="space-y-3">
              <label className="text-[10px] font-black uppercase tracking-[0.2em] text-charcoal/40">Industrial ID / Email</label>
              <input type="text" placeholder="WM-2026-NORDIC" className="input-brutal w-full text-sm border-[3px] rounded-xl focus:shadow-[4px_4px_0px_var(--primary)] transition-all duration-300" />
            </div>
            <div className="space-y-3">
              <label className="text-[10px] font-black uppercase tracking-[0.2em] text-charcoal/40">Neural Signature</label>
              <input type="password" placeholder="••••••••" className="input-brutal w-full text-sm border-[3px] rounded-xl focus:shadow-[4px_4px_0px_var(--primary)] transition-all duration-300" />
            </div>
          </div>
